...
import { UserCheck, ArrowLeft, Lock, Sparkles, CheckCircle2 } from 'lucide-react';
import LoginForm from '../components/LoginForm';
import RegisterForm from '../components/RegisterForm';

const JobSeekerAuthPage = ({ initialMode = 'login' }) => {
