...
employerRouter.get('/dashboard', protect, authorize('admin', 'employer'), getEmployerDashboardStats);
employerRouter.get('/reports', protect, authorize('admin', 'employer'), getEmployerDashboardStats);
